...
/*	loginServlet login=new loginServlet();
	if(login.status_guest==true)
		...
		try{
			...
			depart=(String)session.getAttribute("depart");
			ret=(String)session.getAttribute("ret");
			fdep1=(String)session.getAttribute("fdep1");
			fdep2=(String)session.getAttribute("fdep2");
			farr1=(String)session.getAttribute("farr1");
			farr2=(String)session.getAttribute("farr2");
			fsource=(String)session.getAttribute("fsource");
			fdest=(String)session.getAttribute("fdest");
			count=(Integer)session.getAttribute("count");
		 }else
			{
		 ...
		 out.println("<div><form action='successPayment.jsp' method='post'>");
        ...
        for(int i=1;i<=count;i++)
        {
       	...
       	out.println("<tr><td><input type='text' id='Pname' name= Pname"+i+" required></td>");
        out.println("<td><input type='text' id='Page' name= Page"+i+" required></td>");
        out.println("<td><input type='text' id='Psex' name= Psex"+i+" required></td></tr>");
