...
function findTotalPrice(){
      ...
      //var pricef1=0;
      //var pricef2=0;
      var pricef1 = document.getElementById('price1').value;
      var pricef2 = document.getElementById('price2').value;
      var Fdep1= document.getElementById("fdep1").value;
	  var Fdep2= document.getElementById("fdep2").value;
	  var Farr1= document.getElementById("farr1").value;
	  var Farr2= document.getElementById("farr2").value;
	  var Fsource= document.getElementById("fsource").value;
	  var Fdest= document.getElementById("fdest").value;
            ...
            for (var i = 0; i < controls.length; i++) {
                if ((controls[i].type == 'radio') && controls[i].checked)
                    ...
                    //pricef1 = parseFloat(controls[0].value);
                    //pricef2 = parseFloat(controls[1].value);
            }
        var totalprice = total * count;
        document.getElementById('totalprice').value = totalprice;
        document.getElementById('pricef1').value = pricef1;
        document.getElementById('pricef2').value = pricef2;
        document.getElementById('Totalprice').value = totalprice;
        document.getElementById("Fdep1").value = Fdep1;
	    document.getElementById("Fdep2").value = Fdep2;
	    document.getElementById("Farr1").value = Farr1;
	    document.getElementById("Farr2").value = Farr2;
	    document.getElementById('Fsource').value = Fsource;
	    document.getElementById('Fdest').value = Fdest;
...
<div id="id01" class="modal">
	  ...
	  <form class="modal-content animate" action="${pageContext.request.contextPath}/loginServlet" method="post">
		...
		<div class="container">
		  ...
		  <input type="hidden"  name="pricef1" id="pricef1">
		  <input type="hidden"  name="pricef2" id="pricef2">
          ...
          out.println("<input type='hidden'  name='Fsource' id='Fsource'>");
		  out.println("<input type='hidden'  name='Fdest' id='Fdest'>");
		  out.println("<input type='hidden'  name='Fdep1' id='Fdep1'>");
		  out.println("<input type='hidden'  name='Farr1' id='Farr1'>");
		  out.println("<input type='hidden'  name='Fdep2' id='Fdep2'>");
		  out.println("<input type='hidden'  name='Farr2' id='Farr2'>");
		  //out.println("<input type='hidden'  name='userid' id='userid' value='"+userid+"'>");
		  %>

		  <input type="submit" name="submit" value="Guest Login">
...
<% 
	...
	try
		...
		out.println("<br>");
        if (!userid.equals("a")){
        out.println("<p align='center'><input type='submit' name='submit' value='Book Ticket'></p></form></div>");
        String check="Book Ticket" ;
