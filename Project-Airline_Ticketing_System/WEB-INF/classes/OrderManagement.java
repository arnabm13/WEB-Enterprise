...
public class OrderManagement extends HttpServlet implements Serializable
{
	...
	{
		HashMap<String, Order> orderdetail2 = new HashMap<String, Order>();
		System.out.println("!~!!!!!!!! GET PRODUCT REACHED");
		String pid = request.getParameter("pid");
		orderdetail2=MySqlDataStoreUtilities.getallOrders();
		Order order = orderdetail2.get(pid);
	...
	*/
	...
	public void updateProduct(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException 
	{
		...
		MySqlDataStoreUtilities.InsertOrder(Bid,Fid,Uid,Fsource,Fdestination,Fdep,Farrival,Ftype,Totcost,Passengers,Date);
    ...
    throws ServletException, IOException 
	{
		...
		for (String key : orderdetail.keySet()) 
		{
			...
			out.println("<tr>");
			out.println("<td><font color=\"blue\"> <a id=\""+id+"\" onClick=\"getBookingDetails(this.id)\">"+ord.getBid()+ "</font></a></td>");
			out.println("<td>"+ord.getFid()+ "</font></td>");
