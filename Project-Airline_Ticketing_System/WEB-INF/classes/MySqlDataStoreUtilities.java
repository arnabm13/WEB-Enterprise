...
public class MySqlDataStoreUtilities
{
	...
	public static HashMap<String,Order> getallOrders()
	{
      ...
      //  Database credentials
		...
		Statement stmt = conn.createStatement();
		String sql;
		sql = "select Fid,Uid,Bid,Fsource,Fdestination,Fdep,Farrival,Totcost,Passengers,Date,Ftype from order_detail";
		ResultSet rs = stmt.executeQuery(sql);
		...
		order.setFtype(rs.getString("Ftype"));
	...
	public static void InsertOrder(String Bid,String Fid,String Uid,String Fsource,String Fdestination,String Fdep,String Farrival,String Ftype,Float Totcost,Integer Passengers,String Date)
	{
		try
		{
		String JDBC_DRIVER="com.mysql.jdbc.Driver";  
      ...
      //  Database credentials
        ...
        Connection conn = DriverManager.getConnection(DB_URL, USER, PASS);	
		Statement stmt = conn.createStatement();
		String insertIntoCustomerRegisterQuery = "INSERT INTO order_detail(Bid,Fid,Uid,Fsource,Fdestination,Fdep,Farrival,Ftype,Totcost,Passengers,Date) "+ "VALUES (?,?,?,?,?,?,?,?,?,?,?);";
		//String fname,String lname,String email,String name,String Pass,String utype
		...
		pst.setString(5,Fdestination);
		pst.setString(6,Fdep);
		pst.setString(7,Farrival);
		pst.setString(8,Ftype);
		pst.setFloat(9,Totcost);
		pst.setInt(10,Passengers);
	...
	public static void InsertBooking(String Bid,Integer Num,String Name,Integer Age,String Sex)
	{
		try
		{
		String JDBC_DRIVER="com.mysql.jdbc.Driver";  
      ...
      //  Database credentials
        ...
        Connection conn = DriverManager.getConnection(DB_URL, USER, PASS);	
		Statement stmt = conn.createStatement();
		String insertIntoCustomerRegisterQuery = "INSERT INTO booking_detail(Bid,Num,Name,Age,Sex)"+ "VALUES (?,?,?,?,?);";
		//String fname,String lname,String email,String name,String Pass,String utype
	...
	public static Integer selectRowCount()
	{ 
		int rcount=0;
		try
		{
      ...
      //  Database credentials
        ...
        Connection conn = DriverManager.getConnection(DB_URL, USER, PASS);	
		Statement stmt = conn.createStatement();
		String selectRowCount = "select count(1) from booking_detail;";
		//String fname,String lname,String email,String name,String Pass,String utype
		
		PreparedStatement pst =conn.prepareStatement(selectRowCount);
	...
	public static ArrayList<Order> selectOrder(String userid) 
	{
		...
		{ 
			...
			String selectOrderQuery ="select Fid,Bid,Fsource,Fdestination,Fdep,Farrival,Totcost,Passengers,Date,Ftype from order_detail where Uid=?;"; 
...
public static void updateflightcount(String Fid,String Date)
	{
		try
		{
			Class.forName("com.mysql.jdbc.Driver").newInstance();
			...
			String updateflightcount = "UPDATE flight_count a join order_detail b on a.Fid = b.Fid and  a.Date = b.Date SET a.Occupied = a.Occupied + b.Passengers where  a.Fid = ? and  a.Date = ?;";

			PreparedStatement pst = conn.prepareStatement(updateflightcount);
			pst.setString(1,Fid);  
